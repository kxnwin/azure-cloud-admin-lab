...
## Tasks
- [ ] Confirm on-prem test users sync into Entra ID via Entra Connect
- [ ] Verify synced users land in the correct cloud groups/RBAC roles
- [ ] Write up the full end-to-end flow: on-prem AD → Entra Connect →
      Entra ID → RBAC assignment
- [ ] Diagram the hybrid identity architecture (even a simple sketch helps
